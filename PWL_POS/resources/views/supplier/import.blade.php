        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="{{ url('/supplier/export_template') }}" class="btn btn-info btn-sm" download><i class="fa fa-file-excel"></i> Download</a>
                    <small class="form-text text-muted">Download template Excel untuk import data supplier</small>
                </div>
                <div class="form-group">
                ...
                <div class="alert alert-info">
                    ...
                    <ul>
                        ...
                        <li>Kode Supplier maksimal 10 karakter</li>
                    </ul>
                </div>
            </div>
