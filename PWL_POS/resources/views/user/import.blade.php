        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="{{ url('/user/export_template') }}" class="btn btn-info btn-sm" download><i class="fa fa-file-excel"></i> Download</a>
                    <small class="form-text text-muted">Download template Excel untuk import data user</small>
                </div>
                <div class="form-group">
                ...
                <div class="alert alert-info">
                    ...
                    <ul>
                        ...
                        <li>Ukuran maksimal file adalah 1MB</li>
                        <li>Pastikan format data sesuai dengan template</li>
                        <li>Level ID: Sesuaikan dengan ID level yang ada pada sistem</li>
                    </ul>
                </div>
            </div>
